...
export const additionalProjects: Project[] = [
  {
    ...
    status: 'Live',
    description:
      'A lightweight password generator designed to help users quickly create strong, secure passwords through customizable rules and instant feedback.',
    features: [
      'Generates two unique random passwords simultaneously for easy comparison and selection',
      'Adjustable password length with user-controlled limits (up to 15 characters)',
      'One-click regeneration for instant password refresh',
      'Custom character selection, allowing users to include or exclude letters, numbers, and symbols',
      'Click-to-copy functionality for fast and error-free password usage',
    ],
  ...
  },
  {
    ...
    status: 'Live',
    description:
      'A playful, interactive web experiment designed to manipulate user choice through motion-based UI patterns, nudging users toward selecting Ronaldo for a decisive penalty moment.',
    features: [
      'Cursor-aware UI interaction where the "Me" button dynamically evades hover events, preventing selection',
      'Progressive repositioning logic that changes button location on every failed attempt',
      'Correct selection triggers dynamic content loading using the Fetch API, displaying random Ronaldo quotes from a local JSON source',
      'Final state cleanup where both buttons disappear, providing a clear and satisfying interaction conclusion',
    ],
    techStack: ['HTML', 'CSS', 'JavaScript', 'Fetch API', 'JSON'],
